...
public class Chessboard extends JComponent {
    ...
    public void initiateChessboard() {
        ...
        initPawnOnBoard(1, CHESSBOARD_SIZE - 2, ChessColor.BLACK);
        initPawnOnBoard(1, 2, ChessColor.BLACK);
        initPawnOnBoard(1, CHESSBOARD_SIZE - 3, ChessColor.BLACK);
        initPawnOnBoard(1, 3, ChessColor.BLACK);
        initPawnOnBoard(1, CHESSBOARD_SIZE - 4, ChessColor.BLACK);
        ...
        initPawnOnBoard(CHESSBOARD_SIZE - 2, CHESSBOARD_SIZE - 2, ChessColor.WHITE);
        initPawnOnBoard(CHESSBOARD_SIZE - 2, 2, ChessColor.WHITE);
        initPawnOnBoard(CHESSBOARD_SIZE - 2, CHESSBOARD_SIZE - 3, ChessColor.WHITE);
        initPawnOnBoard(CHESSBOARD_SIZE - 2, 3, ChessColor.WHITE);
        initPawnOnBoard(CHESSBOARD_SIZE - 2, CHESSBOARD_SIZE - 4, ChessColor.WHITE);
