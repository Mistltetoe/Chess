...
public class ClickController {
    ...
    public void onClick(ChessComponent chessComponent) {
                ...
                if (first instanceof PawnChessComponent){
                    if (!handleSecond(chessComponent)){
                        if (chessboard.getCurrentColor()==ChessColor.BLACK){
                            if (getLastStep().charAt(1)=='6' &&
                                    getLastStep().charAt(4)=='4' &&
                                    getLastStep().charAt(0)=='p' &&
                                    chessComponent.getChessboardPoint().getY()+48==getLastStep().charAt(5)){
                            ...
                            if (getLastStep().charAt(1)=='1' &&
                                    getLastStep().charAt(4)=='3' &&
                                    getLastStep().charAt(0)=='P' &&
                                    chessComponent.getChessboardPoint().getY()+48==getLastStep().charAt(5)){
                                saveStep(first,chessComponent);
                                chessboard.passPawn(first,chessComponent);
        ...
        if (testWhite!=0){
            JOptionPane.showMessageDialog(null,null,"White Player Win",JOptionPane.INFORMATION_MESSAGE);
        }
        if (testBlack!=0){
            JOptionPane.showMessageDialog(null,null,"Black Player Win",JOptionPane.INFORMATION_MESSAGE);
        }
    }
